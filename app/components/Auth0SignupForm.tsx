...
interface Auth0SignupFormProps {
  onSuccess?: () => void;
  onError?: (error: string) => void;
}

export default function Auth0SignupForm({ onSuccess, onError }: Auth0SignupFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // This is more reliable than using Management API
      const signupUrl = `/api/auth/[...auth0]?action=login&screen_hint=signup`;
