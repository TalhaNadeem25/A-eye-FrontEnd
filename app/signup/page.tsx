...
import { Camera, Shield, UserPlus } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="glassmorphism border border-border rounded-lg p-6 shadow-lg">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-muted-foreground">
              Create your account to access the surveillance dashboard
            </p>
          </div>
          ...
          <div className="mt-6 p-4 bg-muted rounded-md">
            ...
            <div className="space-y-1">
              <p className="text-xs text-muted-foreground">• Secure account with Auth0</p>
              <p className="text-xs text-muted-foreground">• Role-based access control</p>
              <p className="text-xs text-muted-foreground">• Real-time surveillance monitoring</p>
              <p className="text-xs text-muted-foreground">• User management capabilities</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
          ...
          <div className="flex flex-col items-center">
            <UserPlus className="text-primary mb-2" size={24} />
            <h3 className="text-sm font-medium text-foreground">Easy Setup</h3>
            <p className="text-xs text-muted-foreground">Quick account creation</p>
          </div>
        </div>
      </div>
    </div>
